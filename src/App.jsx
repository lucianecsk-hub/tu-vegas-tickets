        ...
        {step===totalSteps+1&&!loading&&(
          <div style={{animation:"fadeUp .5s ease"}}>
            <div style={{background:"linear-gradient(135deg,#1a0a0a,#0d1a10)",border:"1px solid rgba(240,192,64,.2)",borderLeft:"3px solid #c0392b",borderRadius:"18px",padding:"24px",marginBottom:"18px",boxShadow:"0 4px 24px rgba(0,0,0,.15)"}}>
                 <div style={{color:"#c0392b",fontSize:"0.75rem",letterSpacing:"0.18em",marginBottom:"12px",fontFamily:"'DM Sans',sans-serif",fontWeight:"700",textTransform:"uppercase"}}>✦ TU PERFIL DE VIAJERO/A</div>     
              {!aiReady?(
                ...
                <div style={{animation:"fadeUp .5s ease"}}>
                {aiTitle&&(<div style={{marginBottom:"14px"}}><div style={{fontSize:"1.08rem",fontWeight:"700",color:"#f0c040",fontFamily:"'Playfair Display',serif",marginTop:"4px"}}>{aiTitle}</div></div>)}
