...
const DB = {
  ...
  ninos: [
    { name:"Flyover Las Vegas",                  emoji:"🪂", price:"Desde $36",  dur:"30 min",     rating:4.7, desc:"Un vuelo simulado sobre Las Vegas. Viento, aromas, movimiento — olvidarás que estás dentro.", url:"https://vegas.vdvm.net/a1LxZQ" },
    ...
    { name:"Shark Reef Aquarium — Mandalay Bay",  emoji:"🦈", price:"Desde $30",  dur:"1.5 hrs",    rating:4.7, desc:"Más de 2,000 animales de 100 especies en el único acuario acreditado de Nevada. Tiburones, dragón de Komodo, cocodrilo dorado y tortugas marinas. Mandalay Bay.", url:"https://vegas.vdvm.net/anqbLb" },
  ...
  deportes: [
    ...
    { name:"Tours guiados por el Allegiant Stadium",           emoji:"🏟️", price:"Desde $72",  dur:"1.5 hrs",        rating:4.8, desc:"Descubre los bastidores del estadio más tecnológico de la NFL. La casa de los Raiders.", url:"https://vegas.vdvm.net/9VM05e" },
